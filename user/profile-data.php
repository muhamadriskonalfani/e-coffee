<?php include('profile-header.php'); ?>
        ...
        <div class="profile-container-center">
            <form method="POST" action="../proses.php">
                ...
                <div class="display-6 title">Personal Information</div>
        ...
        <script>
            document.querySelector('.fa-user').parentElement.style.backgroundColor = 'var(--caramel)';
            document.querySelector('.fa-user').parentElement.style.border = '1px solid var(--caramel)';
            document.querySelector('.fa-user').parentElement.style.color = 'var(--milk)';
        </script>
